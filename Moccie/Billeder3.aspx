<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="Billeder3.aspx.cs" Inherits="Billeder" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <asp:MultiView ID="MultiViewBilled" runat="server" ActiveViewIndex="0">
        ...
        <!-- Produkt Gruppe -->
        <asp:View ID="ViewGrupperGrupper" runat="server">
            <section>
                ...
                <article id="ProduktGruppe">
                    <asp:Repeater ID="RepeaterBilleder" runat="server" DataSourceID="SqlDataSourceGruppeKategori">
                        <ItemTemplate>
                            <div id="Grupper">
        ...
        <!-- Produkt kategorier -->
        <asp:View ID="ViewBilledGruppeProd" runat="server">
            <div id="GruppeMenu">
