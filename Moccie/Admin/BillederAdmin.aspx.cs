...
public partial class Admin_NewsAdmin : System.Web.UI.Page
{
    protected void Button_PicPage_Click(object sender, EventArgs e)
    {
        ...
        {
            TextBox tOverskrift = (TextBox)item.FindControl("TextBox_PicOverskrift");
            TextBox tText = (TextBox)item.FindControl("TextBox_PicText");
            ...
            if (tOverskrift != null && tText != null)
            {
                ...
                cmd.CommandText = "UPDATE InfoText SET Overskrift = @Overskrift, Text = @Text WHERE Lokation = 'PicPage'";
                ...
                Response.Redirect("../Admin/BillederAdmin.aspx");
            }
        }
    }
